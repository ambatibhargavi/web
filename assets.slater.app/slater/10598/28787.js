...
function initVideoModal() {
    ...
    t.addEventListener("click", (() => {
        let e = Flip.getState(n),
            t = Flip.getState(l);
        y.play(0), videoModalOpen = !0, s.appendChild(n), c.appendChild(l), gsap.delayedCall(.001, (() => {
            Flip.from(e, {
                duration: 1.2
            }), Flip.from(t, {
                duration: 1.2,
...
function initPricingCards(e) {
    ...
    let g = e.querySelector('[data-price="card-life"]'),
        ...
        y = g.querySelector('[data-price-overlay="main"]'),
        f = g.querySelector('[data-price-overlay="overlay"]'),
        v = f.querySelectorAll(".single-line"),
        b = !1,
        h = gsap.timeline();
    m.forEach((e => {
        e.addEventListener("click", (() => {
            b ? (b = !1, g.setAttribute("data-card-state", "default"), h.clear(), h.to(v, {
                ...
                autoAlpha: 0
            })) : (b = !0, g.setAttribute("data-card-state", "overlay"), h.clear(), h.to(y, {
                autoAlpha: 0,
                duration: .5
            }).set(f, {
                autoAlpha: 1
...
function initUpdatesPage(e) {
    ...
    t.innerText = r.length, o.forEach((e => {
...
function horizontalLoop(e, t) {
    ...
    return e = gsap.utils.toArray(e), t = t || {}, gsap.context((() => {
        function r(e, t) {
            t = t || {}, Math.abs(e - f) > u / 2 && (e += e > f ? -u : u);
            let a = gsap.utils.wrap(0, u, e),
                r = p[a];
            return r > c.time() != e > f && e !== f && (r += c.duration() * (e > f ? 1 : -1)), (r < 0 || r > c.duration()) && (t.modifiers = {
                time: i
            }), f = a, t.overwrite = !0, gsap.killTweensOf(n), 0 === t.duration ? c.time(i(r)) : c.tweenTo(r, t)
        }
        let o, i, n, l = t.onChange,
            ...
            E = () => {
                ...
                e.forEach(((e, t) => {
                    g[t] = parseFloat(gsap.getProperty(e, "width", "px")), y[t] = S(parseFloat(gsap.getProperty(e, "x", "px")) / g[t] * 100 + gsap.getProperty(e, "xPercent")), a = e.getBoundingClientRect(), m[t] = a.left - (t ? r.right : r.left), r = a
                })), gsap.set(e, {
                    xPercent: e => y[e]
                }), o = e[u - 1].offsetLeft + y[u - 1] / 100 * g[u - 1] - d + m[0] + e[u - 1].offsetWidth * gsap.getProperty(e[u - 1], "scaleX") + (parseFloat(t.paddingRight) || 0)
            },
            x = () => {
            ...
            T = () => {
                let t, a, r, n, l;
                for (c.clear(), t = 0; t < u; t++) a = e[t], r = y[t] / 100 * g[t], n = a.offsetLeft + r - d + m[0], l = n + g[t] * gsap.getProperty(a, "scaleX"), c.to(a, {
            ...
            w = e => {
                let t = c.progress();
                c.progress(0, !0), E(), e && T(), x(), e && c.draggable ? c.time(p[f], !0) : c.progress(t, !0)
            },
            k = () => w(!0);
        if (gsap.set(e, {
                x: 0
                ...
                return e && (f = t, v = !1), t
            }, c.current = () => v ? c.closestIndex(!0) : f, c.next = e => r(c.current() + 1, e), c.previous = e => r(c.current() - 1, e), c.times = p, c.progress(1, !0).progress(0, !0), t.reversed && (c.vars.onReverseComplete(), c.reverse()), t.draggable && "function" == typeof Draggable) {
        ...
        return c.closestIndex(!0), s = f, l && l(e[f], f), a = c, () => window.removeEventListener("resize", k)
    })), a
}
...
function initTabSystem(e) {
    e.querySelectorAll('[data-tabs="wrapper"]').forEach((e => {
        function t(e, t = !1) {
            ...
            u.classList.add("active"), p.classList.add("active"), y.to(g, {
                y: "-120%",
                stagger: .01
            }, 0).to(d, {
                autoAlpha: 0,
...
initMobileMenu(), initUpdatesNumber(document), initPlausibleCustomEvents(document), barba.hooks.leave((() => {
    ...
    views: [{
        ...
        afterEnter(e) {
            let t = e.next.container;
            initHomeDashboard(t), initPlayVideoHover(t), initFlipButtons(t), initSliders(t), initTabSystem(t), initPricingCards(t), initStartTextScroll(t), initModal(), initVideoModal(), initVideos(), initFeaturesIcons(t), initFeaturesCode(t), initAboutScroll(t), awardStackEffect = createStackEffect("[data-rotating-cards]")
        }
    }, {
        namespace: "pricing",
        afterEnter(e) {

...
! function(e, t) {
    ...
    function Draggable(h, p) {
        ...
        return (t = Draggable.get(h)) && t.kill(), e.startDrag = function(e, t) {
            ...
            return Ha(h, Ph), u = !0, Le && "soft" !== e && Le.track(f || h, W ? "x,y" : Q ? "rotation" : "top,left"), h._gsDragID = t = "d" + Ie++, ze[t] = q, f && (f.enable(), f.element._gsDragID = t), (p.bounds || Q) && Ih(), p.bounds && q.applyBounds(), q
        ...
        isDragging: !1,
        isPressed: !1
    }), I.zIndex = 1e3, I.version = "3.12.5", Y() && xe.registerPlugin(I), e.Draggable = I, e.default = I;
